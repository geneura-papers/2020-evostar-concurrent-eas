...
@
  \caption{Boxplot of the number of evaluations for the two population sizes and threads up to 8. }
  \label{fig:eval1}
 \end{figure} 
%
\begin{figure}[h!tb]
...
@
  \caption{Boxplot of the time for the two population sizes and threads up to 8. }
  \label{fig:eval2}
\end{figure}
%
\begin{figure}[h!tb]
...
@
  \caption{Boxplot of evaluation rate for the two population sizes and threads up to 8.}
  \label{fig:eval3}
\end{figure}
