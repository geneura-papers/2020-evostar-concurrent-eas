...
tackle parallelism, which has been used in the evolutionary algorithms since
early on. One of the first papers was published by Cohoon et
...
what the author presents is a synchronous island model with random migration between islands,
but the underlying ideas seem surprisingly modern and relevant.  


The lack of suitably systems was a hurdle for the advancement on this subject, but
