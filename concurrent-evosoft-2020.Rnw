...
This first result was promising, so we tried again using more powerful hardware, a system with 16 total cores and Ubuntu 18.04, using the same Raku version, 2020.02.
...
@
  \caption{Second experiment, boxplot of the time for the two population sizes and threads up to 8. }
  \label{fig:freija:2}
\end{figure}
%
