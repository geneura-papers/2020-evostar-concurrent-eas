...
@
  \caption{Second experiment, boxplot of the time for the two population sizes and threads up to 8. The $y$ axis is logarighmic.}
  \label{fig:freija:2}
\end{figure}
%
